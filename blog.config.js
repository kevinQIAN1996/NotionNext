...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Wenju QIAN's blog', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'A common learnner', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://wenjuqian.tech', // 网站地址
